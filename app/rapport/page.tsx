...
export default function Page() {
  return (
    <section className="container mx-auto px-4 py-8">
      ...
      {/* Choix des Images */}
      <div className="bg-white shadow-md rounded-lg p-6 mb-6 border border-gray-200">
        <h2 className="text-2xl font-semibold mb-4 text-blue-700">Choix des Images</h2>
        <p className="text-base text-gray-700 mb-4">
      ...
      <div className="bg-white shadow-md rounded-lg p-6 mb-6 border border-gray-200">
        <h2 className="text-2xl font-semibold mb-4 text-blue-700">Disposition des Pages</h2>
        <p className="text-base text-gray-700 mb-4">
      ...
      <div className="bg-white shadow-md rounded-lg p-6 mb-6 border border-gray-200">
        <h2 className="text-2xl font-semibold mb-4 text-blue-700">Avantages et Inconvénients de Next.js et Vercel</h2>

        {/* Next.js */}
        <div className="mb-6">
          <h3 className="text-xl font-semibold mb-4 text-blue-600">Next.js</h3>
          <div className="mb-4">
            <h4 className="text-lg font-semibold text-blue-500">Avantages</h4>
          ...
          <div>
            <h4 className="text-lg font-semibold text-blue-500">Inconvénients</h4>
            <ul className="list-disc list-inside text-gray-700">
        ...
        {/* Vercel */}
        <div>
          <h3 className="text-xl font-semibold mb-4 text-blue-600">Vercel</h3>
          <div className="mb-4">
            <h4 className="text-lg font-semibold text-blue-500">Avantages</h4>
            <ul className="list-disc list-inside text-gray-700">
